...
Java_com_limone_limoncher_utils_device_VulkanChecker_nativeSetLogCallback(
        JNIEnv *env,
        jclass clazz,
        jobject callback
) {
...
Java_com_limone_limoncher_utils_device_VulkanChecker_nativeCheckVulkan(
        JNIEnv *env,
        jclass clazz,
        jstring jDriverPath,
        jstring jNativeDir,
...
#undef PUT_FEAT
    ...
    jclass capClass = (*env)->FindClass(env, "com/limone/limoncher/utils/device/VulkanCapabilities");
