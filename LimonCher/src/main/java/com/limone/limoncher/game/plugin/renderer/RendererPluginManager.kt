...
package com.limone.limoncher.game.plugin.renderer

import android.content.Context
import android.content.pm.ApplicationInfo
import com.limone.limoncher.R
import com.limone.limoncher.game.plugin.ApkPlugin
import com.limone.limoncher.game.plugin.ApkPluginManager
import com.limone.limoncher.game.plugin.cacheAppIcon
...
/**
 * FCL、LimonCher 渲染器插件，同时支持使用本地渲染器插件
