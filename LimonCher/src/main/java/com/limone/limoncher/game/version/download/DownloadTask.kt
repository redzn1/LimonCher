...
import com.limone.limoncher.utils.file.check7z
import com.limone.limoncher.utils.file.checkZip
import com.limone.limoncher.utils.file.compareSHA1
 ...
 * 一个待下载文件的完整描述
 * 候选源、目标位置与校验方式
 * 批量执行交给 [BatchDownloader]，单个文件也可以通过 [com.limone.limoncher.game.download.engine.DownloadEngine] 直接驱动
 */
class DownloadTask(
