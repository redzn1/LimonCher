...
import com.limone.limoncher.game.path.getAssetsHome
import com.limone.limoncher.game.path.getLibrariesHome
import com.limone.limoncher.game.plugin.natives.NativePluginManager
import com.limone.limoncher.game.version.download.artifactToPath
import com.limone.limoncher.game.version.download.filterLibrary
import com.limone.limoncher.game.version.download.getLibraryReplacement
...
import com.limone.limoncher.ui.screens.content.elements.QuickPlay
import com.limone.limoncher.utils.file.child
import com.limone.limoncher.utils.logging.Logger
import com.limone.limoncher.utils.network.ServerAddress
import com.limone.limoncher.utils.string.insertJSONValueList
import com.limone.limoncher.utils.string.isEmptyOrBlank
import com.limone.limoncher.utils.string.isLowerTo
import com.limone.limoncher.utils.string.isNotEmptyOrBlank
import com.limone.limoncher.utils.string.toUnicodeEscaped
import java.io.File
    ...
    private fun getJavaArgs(): List<String> {
        ...
        if (account.isLocalAccount()) {
            ...
            if (account.otherBaseUrl!!.contains("auth.mc-user.com")) {
                ...
                val authlibServer = if (account.otherBaseUrl!!.trimEnd('/').equals("https://authserver.ely.by", ignoreCase = true)) {
                    "https://authserver.ely.by/api/authlib-injector"
                } else {
                    account.otherBaseUrl!!
                }
                argsList.add("-javaagent:${LibPath.AUTHLIB_INJECTOR.absolutePath}=$authlibServer")
                argsList.add("-Dauthlibinjector.side=client")
            }
        }
