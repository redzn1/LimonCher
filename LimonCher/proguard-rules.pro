...
-keep class com.limone.limoncher.bridge.** { *; }
-keep class com.limone.limoncher.utils.device.VulkanChecker {
    *;
}
-keep class com.limone.limoncher.utils.device.VulkanCapabilities {
    *;
}
-keep interface com.limone.limoncher.utils.device.VulkanLogCallback {
    *;
}
-keep class com.limone.limoncher.game.input.CriticalNativeTest {
    *;
}
