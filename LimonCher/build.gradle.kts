...
val launcherPackageName = "com.limone.limoncher"
...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "LIMONCHER_BUILD", "\"063-AndroidVer-LimonCher\"")
    }
    ...
    buildTypes {
        ...
        debug {
            ...
            // Use the Android Gradle Plugin's default debug keystore.
        }
    }
